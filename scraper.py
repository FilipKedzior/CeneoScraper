...
while(url):
    ...
    for opinion in opinions:
        ...
        useful = opinion.select_one("button.vote-yes").get_text().strip()
        useless = opinion.select_one("button.vote-no").get_text().strip()
...
#print(author, recomendation, stars, content, useful, useless, published, purchased, pros, cons, sep="\n")
